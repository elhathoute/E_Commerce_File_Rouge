            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="widget-about font-md mb-md-5 mb-lg-0">
                        ...
                        <p class="wow fadeIn animated">
                            <strong>Address: </strong>AIN SEBAA, Casablanca
                        </p>
                        <p class="wow fadeIn animated">
                            <strong>Phone: </strong>+212 5226-66122
                        </p>
                        <p class="wow fadeIn animated">
                            <strong>Email: </strong>prettyshoes@gmail.com
                        </p>
                ...
                <div class="col-lg-2 col-md-3">
                    ...
                    <ul class="footer-list wow fadeIn animated mb-sm-5 mb-md-0">
                        <li><a href="{{ route('e-commerce.about') }}">About Us</a></li>
                        <li><a href="{{ route('e-commerce.contact') }}">Contact Us</a></li>
                    </ul>
                </div>
                <div class="col-lg-2  col-md-3">
